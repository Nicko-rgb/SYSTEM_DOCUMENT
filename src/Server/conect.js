...
app.use((req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'http://localhost:3000'); // Reemplaza con el dominio de tu aplicación React
...
app.get('/api/admins', async (req, res) => {
    try {
        const admins = await Admin.find({}, { _id: 0, carrera: 1, admin: 1, password: 1 });
...
// Iniciar el servidor y conectar a MongoDB Atlas
app.listen(port, () => {
